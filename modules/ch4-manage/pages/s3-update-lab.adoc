...
The new bootc container image and contains an embedded web application, which you will access to verify that the update completed sucessfully.
...
+
IMPORTANT: The first attempt at updating your test VM is expected to fail, but we will troubleshoot for the root cause of the issue and fix it.
...
In this lab, you performed operating system updates on two managed devices, by using the RHEM web interface and its CLI. 
