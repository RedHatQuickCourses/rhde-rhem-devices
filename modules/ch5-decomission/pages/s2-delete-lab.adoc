...
7. Verify that your test devices cannot communicate with their RHEM server anymore.
+
////
...
Jan 12 19:56:56 enroll flightctl-agent[868]: time="2026-01-12T19:56:56.516268Z" level=warning msg="Failed to update device status: update device status failed: 404 Not Found" file="device/status/status.go:159"[core@enroll ~]$ *exit*
--
