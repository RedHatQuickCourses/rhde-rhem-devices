...
You know how to identify each one and saw that you can access these devices, to run troubleshooting commands, directly though RHEM.
You also saw that you can perform most actions by using either the CLI or the web interface.
One of the few actions which requires using the CLI is fetching enrollment request data.
