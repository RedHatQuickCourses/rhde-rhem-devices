...
--
+
NOTE: There is no need to register `servera` because the RHEM services package contains no dependencies other than a container engine (Podman) and the classroom environment contains a mirror of the RHEL 10 packages.
